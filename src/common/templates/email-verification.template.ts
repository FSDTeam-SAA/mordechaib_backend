export function getEmailVerificationTemplate(
  ...
  return {
    subject: `${code} is your Noltra AI email verification code`,
    text: `Your Noltra AI email verification code is: ${code}\n\nThis code expires in ${expiresInMinutes} minutes and can only be used once. If you did not create this account, you can safely ignore this email.`,
    html: `
        ...
        <div style="max-width:600px;margin:0 auto;">
          ...
          <div style="background:#ffffff;border:1px solid #e6eaf2;border-top:0;border-radius:0 0 16px 16px;overflow:hidden;box-shadow:0 10px 30px rgba(50,65,100,.08);">
            ...
            <div style="padding:42px 34px 38px;">
              <div style="display:inline-block;border-radius:999px;background:#f0f4ff;color:#5d7fec;font-size:12px;font-weight:700;letter-spacing:.4px;padding:8px 13px;text-transform:uppercase;">Email verification</div>
              <h1 style="margin:22px 0 12px;font-size:30px;line-height:1.18;letter-spacing:-.8px;color:#182033;">Verify your email</h1>
              <p style="margin:0;color:#667085;font-size:16px;line-height:1.65;">Enter the six-digit code below to finish creating your Noltra AI account.</p>
              ...
              <p style="margin:0;color:#667085;font-size:14px;line-height:1.6;"><strong style="color:#344054;">This code expires in ${expiresInMinutes} minutes</strong> and can only be used once.</p>
              <p style="margin:24px 0 0;color:#98a2b3;font-size:13px;line-height:1.6;">If you did not create this account, you can safely ignore this email.</p>
            </div>
